...
class Map extends Component {
  ...
  componentDidMount(){
    ...
    // setInterval( () => {navigator.geolocation.clearWatch(this.watchId)
    //   console.log("this")}
    //   , 5000);
  }
  ...
  handlePress(marker){
    ...
    Actions.photoIndex({coordinates});
  ...
  openCamera() {
    Actions.camera({watchId: this.watchId});
  }
    ...
    return (
      ...
      {this.state.markers.map( (marker, id) => (
        <MapView.Marker
          ...
          <Image source={{uri: 'https://res.cloudinary.com/deh9l9lyq/image/upload/v1491933507/picture_mhctba.png'}} style={{width: 42, height: 42}} />
        ...
        <Footer
          ...
          source={{uri: 'https://res.cloudinary.com/deh9l9lyq/image/upload/v1491933514/camera_a8umhb.png'}}
          logoutPress={() => this.onLogOutButtonPress()}/>
      </MapView>
    );
  }
