      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.layout}>
          ...
          <Image
            ...
            source={{uri: 'https://res.cloudinary.com/deh9l9lyq/image/upload/v1491779729/tumblr_n87tkzPhnY1r4ueyro1_500_tkyoz4.jpg'}}
          />
        ...
        <View>
          <Text style={styles.greetingText}>
            <Text style={styles.ourText}>our</Text>Map
          </Text>
        </View>
...
const styles = {
  greetingText: {
    ...
    position: 'absolute',
    top: -80,
    fontFamily: 'Chalkduster' //Chalkboard SE
  },
  ourText: {
