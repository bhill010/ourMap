  ...
  return (
    ...
    <Router sceneStyle={{ paddingTop: 0, flex: 1, height: '100%', width: '100%' }}>
      ...
      <Scene key="main" sceneStyle={{ paddingTop: 65 }} initial>
            <Scene onRight={() => Actions.camera()} rightTitle="Upload" key="map" component={MapShow} title="Map" initial tabs={true} tabBarStyle={{ backgroundColor: '#F8F8F8' }} sceneStyle={{ paddingTop: 65 }} />
