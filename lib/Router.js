  ...
  render() {
    ...
    return (
      ...
      <Router sceneStyle={{ paddingTop: 0, flex: 1, height: '100%', width: '100%' }}>
          ...
          <Scene key="main" rightTitle="Logout" onRight={() => this.onLogOutButtonPress()} rightButtonTextStyle={styles.rightButtonText} sceneStyle={{ paddingTop: 65 }} navigationBarStyle={styles.navBarStyle} titleStyle={styles.navBarTextStyle} >
